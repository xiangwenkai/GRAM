...
# train_sdf_paths = "/cluster/home/wenkai/dgl_graphormer_local/geom_drugs/data/processed/p1/train/*"
# val_sdf_paths = "/cluster/home/wenkai/dgl_graphormer_local/geom_drugs/data/processed/p1/val/*"
# test_sdf_paths = "/cluster/home/wenkai/dgl_graphormer_local/geom_drugs/data/processed/p1/test/*"
train_sdf_paths = "E:/DATA/dgl_graphormer/geom_drugs/processed/p1/test/test/*"
val_sdf_paths = "E:/DATA/dgl_graphormer/geom_drugs/processed/p1/val/*"
test_sdf_paths = "E:/DATA/dgl_graphormer/geom_drugs/processed/p1/val/*"
...
# stopper = EarlyStopping(mode='lower', filename='/cluster/home/wenkai/dgl_graphormer_local/geom_drugs/gemo_graphormer_pretrain.pth', patience=80)
stopper = EarlyStopping(mode='lower', filename='models/gemo_graphormer_pretrain.pth', patience=80)
if __name__ == '__main__':
    ...
    while True:
        ...
        for batch_id, batch_data in enumerate(train_loader):
            ...
            if loss_G.item() < 2. and k.shape[0] >= 20 and tc < 300000:
                print(loss_G.item(), k.shape[0])
                pdb_block = Chem.MolToPDBBlock(mol[0])
                with open(r'C:\Users\xwk\PycharmProjects\dgl_graphormer_local\geom_drugs\pdb1\real{}.pdb'.format(tc), 'w') as f:
                    f.write(pdb_block)
                ...
                pdb_block = Chem.MolToPDBBlock(mol[0])
                with open(r'C:\Users\xwk\PycharmProjects\dgl_graphormer_local\geom_drugs\pdb1\pre{}.pdb'.format(tc), 'w') as f:
                    f.write(pdb_block)
            elif tc >= 300000:
                stop = 1
        ...
        epoch += 1
        if epoch % 1 == 0:
            torch.save(model.state_dict(), r'E:\MODEL\dgl_graphormer\model\graphormer_gemo_pretrain\base\checkpoints_{}_{}.pt'.format(epoch, time.strftime("%Y%m%d%H", time.localtime())))
