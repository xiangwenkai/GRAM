...
out = open("graphormer_sider_finetune.txt", "a+")
...
# stopper = EarlyStopping(mode='lower', filename='/cluster/home/wenkai/dgl_graphormer_local/geom_drugs/graphormer_sider_finetune.pth', patience=80)
