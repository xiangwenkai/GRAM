...
def run_an_eval_epoch(model, model_3D, val_loader):
    ...
    for batch_id, batch_data in enumerate(val_loader):
        ...
        pred_ = F.softmax(b_prediction, dim=-1).detach().cpu()[:, 1]
...
out = open("/cluster/home/wenkai/dgl_graphormer_local/geom_drugs/graphormer_{}_finetune_{}.txt".format(name, pretrain_flag), "a+")
